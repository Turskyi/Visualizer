package io.github.turskyi.visualizerjava;
...
import io.github.turskyi.visualizerjava.audiovisuals.AudioInputReader;
import io.github.turskyi.visualizerjava.audiovisuals.VisualizerView;
...
public class MainActivity extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void loadColorFromPreferences(SharedPreferences sharedPreferences) {
        mVisualizerView.setColor(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.pref_color_key),
                getString(R.string.pref_color_red_value))));
    }

    private void loadSizeFromSharedPreferences(SharedPreferences sharedPreferences) {
        float minSize = Float.parseFloat(Objects.requireNonNull(sharedPreferences.getString(getString(R.string.pref_size_key),
